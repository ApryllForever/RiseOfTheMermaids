...
{
	public class DesertButterfly : Critter
	{
		...
		public DesertButterfly(Vector2 position, bool islandButterfly = false)
		{
			...
			string desertButterflyTexture = (Mod.instance.Helper.ModContent.GetInternalAssetName("assets/maps/critters.png").BaseName);
			sprite = new AnimatedSprite(desertButterflyTexture, baseFrame, 16, 16);
			sprite.loop = false;
		...
		public DesertButterfly setStayInbounds(bool stayInbounds)
		{

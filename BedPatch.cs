...
namespace RestStopLocations
{
    ...
    public static class HarmonyPatch_BedPlacement
    {
        ...
        public static void ApplyPatch(Harmony harmony, IMonitor monitor)
        {
            ...
            //MapPropertyName = Mod.PropertyPrefix + "BedPlacement"; //assign map property name
        ...
        public static bool ShouldBedsBePlaceableHere(GameLocation location)
        {
            ...
            if (Game1.currentLocation is SapphireFarmHouse) 
            {
        ...
        private static void GameLocation_CanPlaceThisFurnitureHere(GameLocation __instance, Furniture furniture, ref bool __result)
        {
            ...
            {
                Monitor.LogOnce($"Harmony patch \"{nameof(HarmonyPatch_BedPlacement)}\" has encountered an error. Full error message: \n{ex.ToString()}", LogLevel.Error);
                return;
            }
        }
    }

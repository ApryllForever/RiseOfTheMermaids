...
namespace RestStopLocations
{
    internal class Otter: Critter
    {
			...
			public Otter()
			{
				sprite = new AnimatedSprite(Mod.instance.Helper.ModContent.GetInternalAssetName("assets/animals/Otter.png").BaseName);
				sprite.SourceRect = _baseSourceRectangle;
				sprite.ignoreSourceRectUpdates = true;
				UpdateSpriteRectangle();
			}

			public Otter(Vector2 start_position)
				: this()
			{

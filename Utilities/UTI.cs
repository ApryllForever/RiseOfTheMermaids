...
namespace UtilitiesStuff
{
    ...
    internal static class UtilFunctions
    {
        ...
        internal static IEnumerable<ItemQueryResult> MuseumQuery(string key, string? arguments, ItemQueryContext context, bool avoidRepeat, HashSet<string>? avoidItemIds, Action<string, string> logError)
        {
            ...
            List<string> items = new(args.Length - 1);

            foreach (var item in args.AsSpan(1))
            {
            ...
            {
                return items.Select(static qID => new ItemQueryResult(ItemRegistry.Create(qID)));
            }

            Span<string> backing = CollectionsMarshal.AsSpan(items);
            ShuffledYielder<string> shuffler = new(backing);
            List<ItemQueryResult> results = new(count);

            while (shuffler.MoveNext() && results.Count < count)
            {
                var id = shuffler.Current;
                results.Add(new(ItemRegistry.Create(id)));
            }
...
/*  Old Stardew 1.5 Utilities Class -- Presevered because so much usable groviness!
...
namespace StardewValley
{
    public class Utility
    {
        ...
        public static string fuzzySearch(string query, List<string> word_bank)
        {
            ...
            {
                if (Utility._formatForFuzzySearch(query) == Utility._formatForFuzzySearch(term3))
                {
                    return term3;
                }
            }
            ...
            {
                if (Utility._formatForFuzzySearch(term2).StartsWith(Utility._formatForFuzzySearch(query)))
                {
                    return term2;
                }
            }
        ...
        public static Item fuzzyItemSearch(string query, int stack_count = 1)
        {
            ...
            if (result != null)
            {
                return Utility.getItemFromStandardTextDescription(items[result], null);
            }
            return null;
        }
        ...
        public static GameLocation fuzzyLocationSearch(string query)
        {
            ...
            string location_name = Utility.fuzzySearch(query, name_bank.Keys.ToList());
        ...
        public static FarmAnimal fuzzyAnimalSearch(string query)
        {
            ...
            string character_name = Utility.fuzzySearch(query, name_bank.Keys.ToList());
        ...
        public static Color Get2PhaseColor(Color color1, Color color2, int offset = 0, float speedMultiplier = 1f, float timeOffset = 0f)
        {
            ...
            prismatic_color.R = (byte)(Utility.Lerp((float)(int)a.R / 255f, (float)(int)b.R / 255f, position) * 255f);
            prismatic_color.G = (byte)(Utility.Lerp((float)(int)a.G / 255f, (float)(int)b.G / 255f, position) * 255f);
            prismatic_color.B = (byte)(Utility.Lerp((float)(int)a.B / 255f, (float)(int)b.B / 255f, position) * 255f);
            prismatic_color.A = (byte)(Utility.Lerp((float)(int)a.A / 255f, (float)(int)b.A / 255f, position) * 255f);
            return prismatic_color;
        }
        ...
        internal static void makeSafeY(ref int y, int height)
        {
            ...
            y = (int)Utility.makeSafe(pos, size).Y;
        }
        ...
        private static Dictionary<ISalable, int[]> generateLocalTravelingMerchantStock(int seed)
        {
            ...
            for (int i = 0; i < 10; i++)
            {
                ...
                while (true)
                {
                    ...
                    if (Game1.objectInformation.ContainsKey(index) && !Utility.isObjectOffLimitsForSale(index))
                    {
                        ...
                        if (split[3].Contains('-') && Convert.ToInt32(split[1]) > 0 && !split[3].Contains("-13") && !split[3].Equals("Quest") && !split[0].Equals("Weeds") && !split[3].Contains("Minerals") && !split[3].Contains("Arch") && Utility.addToStock(stock, stockIndices, new Object(index, 1), new int[2]
                        {
            ...
            if (add_guaranteed_item)
            {
                ...
                Utility.addToStock(stock, stockIndices, new Object(485, 1), new int[2]
                {
                    Math.Max(r.Next(1, 11) * 100, Convert.ToInt32(split2[1]) * r.Next(3, 6)),
                    (!(r.NextDouble() < 0.1)) ? 1 : 5
                });
            }
            Utility.addToStock(stock, stockIndices, Utility.getRandomFurniture(r, null, 0, 1613), new int[2]
            {
                r.Next(1, 11) * 250,
                1
            });
            ...
            {
                Utility.addToStock(stock, stockIndices, new Object(347, 1), new int[2]
                {
                    1000,
                    (!(r.NextDouble() < 0.1)) ? 1 : 5
                });
            ...
            {
                Utility.addToStock(stock, stockIndices, new Object(Vector2.Zero, 136), new int[2] { 4000, 1 });
            }
            if (r.NextDouble() < 0.25)
            {
                Utility.addToStock(stock, stockIndices, new Object(433, 1), new int[2] { 2500, 1 });
            }
            return stock;
        }
        ...
        {
            Dictionary<ISalable, int[]> localStock = Utility.generateLocalTravelingMerchantStock(seed);
            ...
            if (Game1.IsMultiplayer && !Game1.player.craftingRecipes.ContainsKey("Wedding Ring"))
            {
                ...
                localStock.Add(weddingRingRecipe, new int[2] { 500, 1 });
            }
            return localStock;
        }
        ...
        {
            Dictionary<ISalable, int[]> stock = new Dictionary<ISalable, int[]>();
            stock.Add(new Object(773, 1), new int[2] { 2000, 2147483647 });
            stock.Add(new Object(772, 1), new int[2] { 3000, 2147483647 });
            stock.Add(new Object(286, 1), new int[2] { 300, 2147483647 });
            stock.Add(new Object(287, 1), new int[2] { 600, 2147483647 });
            stock.Add(new Object(288, 1), new int[2] { 1000, 2147483647 });
            stock.Add(new Object(243, 1), new int[2] { 1000, 2147483647 });
            stock.Add(new Object(Vector2.Zero, 138), new int[2] { 2500, 2147483647 });
            stock.Add(new Object(Vector2.Zero, 32), new int[2] { 200, 2147483647 });
            if (!Game1.player.craftingRecipes.ContainsKey("Weathered Floor"))
            {
                stock.Add(new Object(331, 1, isRecipe: true), new int[2] { 500, 1 });
            }
            return stock;
        }
        ...
        {
            Dictionary<ISalable, int[]> stock = new Dictionary<ISalable, int[]>();
            stock.Add(new Object(349, 1), new int[2] { 1000, 2147483647 });
            stock.Add(new Object(351, 1), new int[2] { 1000, 2147483647 });
            return stock;
        }
        ...
        {
            return Utility.getFarmerItemsShippedPercent() >= 1f;
        }

        public static Dictionary<ISalable, int[]> getQiShopStock()
        {
            Dictionary<ISalable, int[]> stock = new Dictionary<ISalable, int[]>();
            stock.Add(new Furniture(1552, Vector2.Zero), new int[2] { 5000, 2147483647 });
            stock.Add(new Furniture(1545, Vector2.Zero), new int[2] { 4000, 2147483647 });
            stock.Add(new Furniture(1563, Vector2.Zero), new int[2] { 4000, 2147483647 });
            stock.Add(new Furniture(1561, Vector2.Zero), new int[2] { 3000, 2147483647 });
            stock.Add(new Hat(2), new int[2] { 8000, 2147483647 });
            stock.Add(new Object(Vector2.Zero, 126), new int[2] { 10000, 2147483647 });
            stock.Add(new Object(298, 1), new int[2] { 100, 2147483647 });
            stock.Add(new Object(703, 1), new int[2] { 1000, 2147483647 });
            stock.Add(new Object(688, 1), new int[2] { 500, 2147483647 });
            stock.Add(new BedFurniture(2192, Vector2.Zero), new int[2] { 8000, 2147483647 });
            return stock;
        }
        ...
        public static Dictionary<ISalable, int[]> getJojaStock()
        {
            ...
            {
                stock.Add(new Object(Vector2.Zero, 272), new int[2] { 50000, 2147483647 });
            }
            stock.Add(new Object(Vector2.Zero, 167, int.MaxValue), new int[2] { 75, 2147483647 });
        ...
        public static Dictionary<ISalable, int[]> getHatStock()
        {
            ...
            foreach (KeyValuePair<int, string> v in dictionary)
            {
                ...
                {
                    stock.Add(new Hat(Convert.ToInt32(v.Value.Split('^')[4])), new int[2] { 1000, 2147483647 });
                }
                else
                {
                    foundAll = false;
            ...
            {
                stock.Add(new Hat(4), new int[2] { 1000, 2147483647 });
            }
            if (Game1.player.mailReceived.Contains("Ice Festival"))
            {
                stock.Add(new Hat(17), new int[2] { 1000, 2147483647 });
            }
            if (Game1.player.achievements.Contains(17))
            {
                stock.Add(new Hat(61), new int[2] { 1000, 2147483647 });
            }
            if (foundAll)
            {
                stock.Add(new Hat(64), new int[2] { 1000, 2147483647 });
            }
            return stock;
        }
        ...
        public static bool highlightLuauSoupItems(Item i)
        {
            if (i is Object)
            {
                if (((int)(i as Object).edibility == -300 || (i as Object).Category == -7) && !Utility.IsNormalObjectAtParentSheetIndex(i, 789))
                {
        ...
        public static bool highlightSantaObjects(Item i)
        {
            ...
            return Utility.highlightSmallObjects(i);
        }
        ...
        public static int getFarmerNumberFromFarmer(Farmer who)
        {
            ...
            {
                if (Utility.getFarmerFromFarmerNumber(i).UniqueMultiplayerID == who.UniqueMultiplayerID)
                {
                    return i;
                }
            }
        ...
        {
            Dictionary<ISalable, int[]> stock = new Dictionary<ISalable, int[]>();
            stock.Add(new Object(219, 1), new int[2] { 250, 2147483647 });
            if ((int)Game1.player.fishingLevel >= 2)
            {
                stock.Add(new Object(685, 1), new int[2] { 5, 2147483647 });
            }
            if ((int)Game1.player.fishingLevel >= 3)
            {
                stock.Add(new Object(710, 1), new int[2] { 1500, 2147483647 });
            }
            if ((int)Game1.player.fishingLevel >= 6)
            {
                stock.Add(new Object(686, 1), new int[2] { 500, 2147483647 });
                stock.Add(new Object(694, 1), new int[2] { 500, 2147483647 });
                stock.Add(new Object(692, 1), new int[2] { 200, 2147483647 });
            }
            if ((int)Game1.player.fishingLevel >= 7)
            {
                stock.Add(new Object(693, 1), new int[2] { 750, 2147483647 });
                stock.Add(new Object(695, 1), new int[2] { 750, 2147483647 });
            }
            if ((int)Game1.player.fishingLevel >= 8)
            {
                stock.Add(new Object(691, 1), new int[2] { 1000, 2147483647 });
                stock.Add(new Object(687, 1), new int[2] { 1000, 2147483647 });
            }
            if ((int)Game1.player.fishingLevel >= 9)
            {
                stock.Add(new Object(703, 1), new int[2] { 1000, 2147483647 });
            }
            stock.Add(new FishingRod(0), new int[2] { 500, 2147483647 });
            stock.Add(new FishingRod(1), new int[2] { 25, 2147483647 });
            if ((int)Game1.player.fishingLevel >= 2)
            {
                stock.Add(new FishingRod(2), new int[2] { 1800, 2147483647 });
            }
            if ((int)Game1.player.fishingLevel >= 6)
            {
                stock.Add(new FishingRod(3), new int[2] { 7500, 2147483647 });
            }
            if (Game1.MasterPlayer.mailReceived.Contains("ccFishTank"))
            {
                stock.Add(new Pan(), new int[2] { 2500, 2147483647 });
            }
            stock.Add(new FishTankFurniture(2304, Vector2.Zero), new int[2] { 2000, 2147483647 });
            stock.Add(new FishTankFurniture(2322, Vector2.Zero), new int[2] { 500, 2147483647 });
            if (Game1.player.mailReceived.Contains("WillyTropicalFish"))
            {
                stock.Add(new FishTankFurniture(2312, Vector2.Zero), new int[2] { 5000, 2147483647 });
            }
            stock.Add(new BedFurniture(2502, Vector2.Zero), new int[2] { 25000, 2147483647 });
            ...
            if (shop is ShopLocation)
            {
                foreach (Item i in (shop as ShopLocation).itemsFromPlayerToSell)
                {
                    if (i.Stack > 0)
                    {
                        ...
                        stock.Add(i, new int[2] { price, i.Stack });
                    }
                }
                return stock;
            }
        ...
        public static string ParseGiftReveals(string str)
        {
            try
            {
                while (str.Contains("%revealtaste"))
                {
                    ...
                    int item_index = int.Parse(str.Substring(token_start, token_end - token_start));
        ...
        public static void addSprinklesToLocation(GameLocation l, int sourceXTile, int sourceYTile, int tilesWide, int tilesHigh, int totalSprinkleDuration, int millisecondsBetweenSprinkles, Color sprinkleColor, string sound = null, bool motionTowardCenter = false)
        {
            ...
            for (int i = 0; i < numSprinkles; i++)
            {
                ...
                l.temporarySprites.Add(new TemporaryAnimatedSprite(r.Next(10, 12), currentSprinklePosition, sprinkleColor, 8, flipped: false, 50f)
                {
                    ...
                    interval = 100f,
                    startSound = sound,
                    motion = (motionTowardCenter ? Utility.getVelocityTowardPoint(currentSprinklePosition, new Vector2(sourceXTile, sourceYTile) * 64f, Vector2.Distance(new Vector2(sourceXTile, sourceYTile) * 64f, currentSprinklePosition) / 64f) : Vector2.Zero),
        ...
        {
            return Utility.GetPointsOnLine(x0, y0, x1, y1, ignoreSwap: false);
        }
        ...
        public static string getCelebrationPositionsForDatables(string personToExclude)
        {
            ...
            return Utility.getCelebrationPositionsForDatables(exclusion_list);
        }
        ...
        public static void fixAllAnimals()
        {
            ...
            foreach (Building b3 in f.buildings)
            {
                ...
                {
                    FarmAnimal a4 = Utility.getAnimal(item);
                    if (a4 != null)
                    {
                        a4.home = b3;
            ...
            foreach (Building b2 in f.buildings)
            {
                ...
                {
                    if (Utility.getAnimal((b2.indoors.Value as AnimalHouse).animalsThatLiveHere[i]).home != b2)
                    {
            ...
            {
                a.Position = Utility.recursiveFindOpenTileForCharacter(a, f, new Vector2(40f, 40f), 200) * 64f;
        ...
        public static List<int> possibleCropsAtThisTime(string season, bool firstWeek)
        {
            ...
            {
                firstWeekCrops = new List<int> { 24, 192 };
                if (Game1.year > 1)
                {
                ...
                secondWeekCrops = new List<int> { 190, 188 };
                if (Utility.doesAnyFarmerHaveMail("ccVault"))
                {
            ...
            {
                firstWeekCrops = new List<int> { 264, 262, 260 };
                secondWeekCrops = new List<int> { 254, 256 };
                if (Game1.year > 1)
                {
                ...
                if (Utility.doesAnyFarmerHaveMail("ccVault"))
                {
                    secondWeekCrops.AddRange(new int[2] { 258, 268 });
                }
                secondWeekCrops.AddRange(firstWeekCrops);
            }
            else if (season.Equals("fall"))
            {
                firstWeekCrops = new List<int> { 272, 278 };
                secondWeekCrops = new List<int> { 270, 276, 280 };
                if (Game1.year > 1)
                {
        ...
        public static int[] cropsOfTheWeek()
        {
            ...
            List<int> firstWeekCrops = Utility.possibleCropsAtThisTime(Game1.currentSeason, firstWeek: true);
            List<int> secondWeekCrops = Utility.possibleCropsAtThisTime(Game1.currentSeason, firstWeek: false);
        ...
        public static int getRandomBasicSeasonalForageItem(string season, int randomSeedAddition = -1)
        {
            ...
            if (season.Equals("spring"))
            {
                possibleItems.AddRange(new int[4] { 16, 18, 20, 22 });
            }
            else if (season.Equals("summer"))
            {
                possibleItems.AddRange(new int[3] { 396, 398, 402 });
            }
            else if (season.Equals("fall"))
            {
                possibleItems.AddRange(new int[4] { 404, 406, 408, 410 });
            }
            else if (season.Equals("winter"))
            {
                possibleItems.AddRange(new int[4] { 412, 414, 416, 418 });
            }
        ...
        public static int getRandomItemFromSeason(string season, int randomSeedAddition, bool forQuest, bool changeDaily = true)
        {
            ...
            List<int> possibleItems = new List<int> { 68, 66, 78, 80, 86, 152, 167, 153, 420 };
            ...
            {
                possibleItems.AddRange(new int[5] { 62, 70, 72, 84, 422 });
            }
            ...
            {
                possibleItems.AddRange(new int[3] { 64, 60, 82 });
            }
            if (Utility.doesAnyFarmerHaveMail("ccVault"))
            {
                possibleItems.AddRange(new int[4] { 88, 90, 164, 165 });
            }
            if (all_unlocked_crafting_recipes.Contains("Furnace"))
            {
                possibleItems.AddRange(new int[4] { 334, 335, 336, 338 });
            }
        ...
        public static float getMaxedFriendshipPercent(Farmer who = null)
        {
            ...
            foreach (KeyValuePair<string, Friendship> friend in who.friendshipData.Pairs)
            {
                ...
                {
                    Friendship value = friend.Value;
                    bool isDatable = disposition[friend.Key].Split('/')[5] == "datable";
                    if (value.Points >= 250 * (isDatable ? 8 : 10))
                    {
                        numMaxedFriends += 1f;
                    }
                }
        ...
        public static float percentGameComplete()
        {
            ...
            total += 15f;
            float num2 = num + Math.Min(Utility.numObelisksOnFarm(), 4f);
            total += 4f;
            ...
            total += 11f;
            float farmerLevelPercent = Utility.GetFarmCompletion((Farmer farmer) => Math.Min(farmer.Level, 25f) / 25f).Value;
        ...
        public static List<string> getOtherFarmerNames()
        {
            ...
            if (Game1.player.IsMale)
            {
                ...
                for (int j = 0; j < 2; j++)
                {
                    ...
                    {
                        name = ((j != 0) ? maleNames[dayRandom.Next(maleNames.Length)] : maleNames[r.Next(maleNames.Length)]);
                    }
                    name = ((j != 0) ? (maletitles[dayRandom.Next(maletitles.Length)] + " " + name) : (maleRivalTitles[r.Next(maleRivalTitles.Length)] + " " + name));
            ...
            else
            {
                ...
                for (int i = 0; i < 2; i++)
                {
                    while (otherFarmerNames.Contains(name) || Game1.player.Name.Equals(name))
                    {
                        name = ((i != 0) ? femaleNames[dayRandom.Next(femaleNames.Length)] : femaleNames[r.Next(femaleNames.Length)]);
                    }
                    name = ((i != 0) ? (femaletitles[dayRandom.Next(femaletitles.Length)] + " " + name) : (femaleRivalTitles[r.Next(femaleRivalTitles.Length)] + " " + name));
                    otherFarmerNames.Add(name);
                }
            }
            if (dayRandom.NextDouble() < 0.5)
            {
                ...
                name = ((!(dayRandom.NextDouble() < 0.5)) ? (name + " " + malegarbageNicknames[dayRandom.Next(malegarbageNicknames.Length)]) : (maleGarbagetitles[dayRandom.Next(maleGarbagetitles.Length)] + " " + name));
            }
            else
            {
        ...
        public static string getStardewHeroStandingsString()
        {
            ...
            otherFarmerScores[0] = (int)((float)Game1.stats.DaysPlayed / 208f * (float)Game1.percentageToWinStardewHero);
            ...
            float farmerScore = Utility.percentGameComplete();
        ...
        public static string getDateStringFor(int currentDay, int currentSeason, int currentYear)
        {
            ...
            return Game1.content.LoadString("Strings\\StringsFromCSFiles:Utility.cs.5678", currentDay, (LocalizedContentManager.CurrentLanguageCode == LocalizedContentManager.LanguageCode.es) ? Utility.getSeasonNameFromNumber(currentSeason).ToLower() : Utility.getSeasonNameFromNumber(currentSeason), currentYear);
        }
        ...
        public static void consolidateStacks(IList<Item> objects)
        {
            ...
            {
                if (objects[j] == null || !(objects[j] is Object))
                {
                    continue;
                }
        ...
        public static void overnightLightning()
        {
            if (Game1.IsMasterGame)
            {
                ...
                {
                    Utility.performLightningUpdate(Game1.timeOfDay + i * 100);
                }
            }
        }
        ...
        {
            return Utility.findCloseFlower(location, startTileLocation, -1, null);
        }
        ...
        public static string getStandardDescriptionFromItem(Item item, int stack, char delimiter = ' ')
        {
            ...
            return identifier + delimiter + index + delimiter + stack;
        }
        ...
        {
            return Utility.getTemporarySpritesWithinArea(new int[2] { 10, 11 }, bounds, numberOfSparkles, sparkleColor, delayBetweenSparkles, delayBeforeStarting, sparkleSound);
        }
        ...
        {
            if (!Utility.isOnScreen(new Vector2(currentNode.x * 64, currentNode.y * 64), 32))
            {
                return true;
            }
            return false;
        ...
        {
            Dictionary<ISalable, int[]> stock = new Dictionary<ISalable, int[]>();
            Utility.AddStock(stock, new Object(Vector2.Zero, 388, int.MaxValue));
            Utility.AddStock(stock, new Object(Vector2.Zero, 390, int.MaxValue));
            Random r = new Random((int)Game1.stats.DaysPlayed + (int)Game1.uniqueIDForThisGame / 2);
            Utility.AddStock(stock, new Furniture(1614, Vector2.Zero));
            Utility.AddStock(stock, new Furniture(1616, Vector2.Zero));
            switch (Game1.dayOfMonth % 7)
            {
            case 1:
                Utility.AddStock(stock, new Furniture(0, Vector2.Zero));
                Utility.AddStock(stock, new Furniture(192, Vector2.Zero));
                Utility.AddStock(stock, new Furniture(704, Vector2.Zero));
                Utility.AddStock(stock, new Furniture(1120, Vector2.Zero));
                Utility.AddStock(stock, new Furniture(1216, Vector2.Zero));
                Utility.AddStock(stock, new Furniture(1391, Vector2.Zero));
                break;
            case 2:
                Utility.AddStock(stock, new Furniture(3, Vector2.Zero));
                Utility.AddStock(stock, new Furniture(197, Vector2.Zero));
                Utility.AddStock(stock, new Furniture(709, Vector2.Zero));
                Utility.AddStock(stock, new Furniture(1122, Vector2.Zero));
                Utility.AddStock(stock, new Furniture(1218, Vector2.Zero));
                Utility.AddStock(stock, new Furniture(1393, Vector2.Zero));
                break;
            case 3:
                Utility.AddStock(stock, new Furniture(6, Vector2.Zero));
                Utility.AddStock(stock, new Furniture(202, Vector2.Zero));
                Utility.AddStock(stock, new Furniture(714, Vector2.Zero));
                Utility.AddStock(stock, new Furniture(1124, Vector2.Zero));
                Utility.AddStock(stock, new Furniture(1220, Vector2.Zero));
                Utility.AddStock(stock, new Furniture(1395, Vector2.Zero));
                break;
            case 4:
                Utility.AddStock(stock, Utility.getRandomFurniture(r, stock, 1296, 1391));
                Utility.AddStock(stock, Utility.getRandomFurniture(r, stock, 1296, 1391));
                break;
            case 5:
                Utility.AddStock(stock, Utility.getRandomFurniture(r, stock, 1443, 1450));
                Utility.AddStock(stock, Utility.getRandomFurniture(r, stock, 288, 313));
                break;
            case 6:
                Utility.AddStock(stock, Utility.getRandomFurniture(r, stock, 1565, 1607));
                Utility.AddStock(stock, Utility.getRandomFurniture(r, stock, 12, 129));
                break;
            case 0:
                Utility.AddStock(stock, Utility.getRandomFurniture(r, stock, 1296, 1391));
                Utility.AddStock(stock, Utility.getRandomFurniture(r, stock, 416, 537));
                break;
            }
            Utility.AddStock(stock, Utility.getRandomFurniture(r, stock));
            Utility.AddStock(stock, Utility.getRandomFurniture(r, stock));
            while (r.NextDouble() < 0.25)
            {
                Utility.AddStock(stock, Utility.getRandomFurniture(r, stock, 1673, 1815));
            }
            Utility.AddStock(stock, new Furniture(1402, Vector2.Zero));
            Utility.AddStock(stock, new Object(Vector2.Zero, 208)
            {
                Stack = int.MaxValue
            });
            if (Game1.currentSeason == "winter" || Game1.year >= 2)
            {
                Utility.AddStock(stock, new Object(Vector2.Zero, 211)
                {
                    Stack = int.MaxValue
                });
            }
            ...
            {
                Utility.AddStock(stock, new Object(Vector2.Zero, 216));
            }
            Utility.AddStock(stock, new Object(Vector2.Zero, 214));
            Utility.AddStock(stock, new TV(1466, Vector2.Zero));
            Utility.AddStock(stock, new TV(1680, Vector2.Zero));
            if (Utility.getHomeOfFarmer(Game1.player).upgradeLevel > 0)
            {
                Utility.AddStock(stock, new TV(1468, Vector2.Zero));
            }
            if (Utility.getHomeOfFarmer(Game1.player).upgradeLevel > 0)
            {
                Utility.AddStock(stock, new Furniture(1226, Vector2.Zero));
            }
            Utility.AddStock(stock, new Object(Vector2.Zero, 200)
            {
                Stack = int.MaxValue
            });
            Utility.AddStock(stock, new Object(Vector2.Zero, 35)
            {
                Stack = int.MaxValue
            });
            Utility.AddStock(stock, new Object(Vector2.Zero, 46)
            {
                Stack = int.MaxValue
            });
            Utility.AddStock(stock, new Furniture(1792, Vector2.Zero));
            Utility.AddStock(stock, new Furniture(1794, Vector2.Zero));
            Utility.AddStock(stock, new Furniture(1798, Vector2.Zero));
            if (Game1.player.eventsSeen.Contains(1053978))
            {
                Utility.AddStock(stock, new BedFurniture(2186, Vector2.Zero));
            }
            Utility.AddStock(stock, new BedFurniture(2048, Vector2.Zero), 250);
            if (Game1.player.HouseUpgradeLevel > 0)
            {
                Utility.AddStock(stock, new BedFurniture(2052, Vector2.Zero), 1000);
            }
            if (Game1.player.HouseUpgradeLevel > 1)
            {
                Utility.AddStock(stock, new BedFurniture(2076, Vector2.Zero), 1000);
            }
            if (!Game1.player.craftingRecipes.ContainsKey("Wooden Brazier"))
            {
                Utility.AddStock(stock, new Torch(Vector2.Zero, 143, bigCraftable: true)
                {
                    IsRecipe = true
                });
            }
            ...
            {
                Utility.AddStock(stock, new Torch(Vector2.Zero, 144, bigCraftable: true)
                {
                    IsRecipe = true
                });
            }
            ...
            {
                Utility.AddStock(stock, new Torch(Vector2.Zero, 150, bigCraftable: true)
                {
                    IsRecipe = true
                });
            }
            ...
            {
                Utility.AddStock(stock, new Torch(Vector2.Zero, 147, bigCraftable: true)
                {
                    IsRecipe = true
                });
            }
            ...
            {
                Utility.AddStock(stock, new Torch(Vector2.Zero, 145, bigCraftable: true)
                {
                    IsRecipe = true
                });
            }
            ...
            {
                Utility.AddStock(stock, new Torch(Vector2.Zero, 148, bigCraftable: true)
                {
                    IsRecipe = true
                });
            }
            ...
            {
                Utility.AddStock(stock, new Torch(Vector2.Zero, 149, bigCraftable: true)
                {
                    IsRecipe = true
                });
            }
            ...
            {
                Utility.AddStock(stock, new Torch(Vector2.Zero, 151, bigCraftable: true)
                {
                    IsRecipe = true
                });
            }
            ...
            {
                Utility.AddStock(stock, new Object(Vector2.Zero, 152, isRecipe: true)
                {
                    IsRecipe = true
                });
            }
            ...
            {
                Utility.AddStock(stock, new Object(Vector2.Zero, 153, isRecipe: true)
                {
                    IsRecipe = true
                });
            }
            ...
            {
                Utility.AddStock(stock, new Object(328, 1, isRecipe: true), 50);
            }
            if (!Game1.player.craftingRecipes.ContainsKey("Rustic Plank Floor"))
            {
                Utility.AddStock(stock, new Object(840, 1, isRecipe: true), 100);
            }
            if (!Game1.player.craftingRecipes.ContainsKey("Stone Floor"))
            {
                Utility.AddStock(stock, new Object(329, 1, isRecipe: true), 50);
            }
            if (!Game1.player.craftingRecipes.ContainsKey("Brick Floor"))
            {
                Utility.AddStock(stock, new Object(293, 1, isRecipe: true), 250);
            }
            if (!Game1.player.craftingRecipes.ContainsKey("Stone Walkway Floor"))
            {
                Utility.AddStock(stock, new Object(841, 1, isRecipe: true), 100);
            }
            if (!Game1.player.craftingRecipes.ContainsKey("Stepping Stone Path"))
            {
                Utility.AddStock(stock, new Object(415, 1, isRecipe: true), 50);
            }
            if (!Game1.player.craftingRecipes.ContainsKey("Straw Floor"))
            {
                Utility.AddStock(stock, new Object(401, 1, isRecipe: true), 100);
            }
            if (!Game1.player.craftingRecipes.ContainsKey("Crystal Path"))
            {
                Utility.AddStock(stock, new Object(409, 1, isRecipe: true), 100);
            }
            return stock;
        }
        ...
        private static Furniture getRandomFurniture(Random r, Dictionary<ISalable, int[]> stock, int lowerIndexBound = 0, int upperIndexBound = 1462)
        {
            ...
            do
            {
                ...
                {
                    if (i is Furniture && (int)i.parentSheetIndex == index)
                    {
                        index = -1;
                    }
                }
            ...
            Furniture furniture = new Furniture(index, Vector2.Zero);
        ...
        public static Dictionary<ISalable, int[]> GetQiChallengeRewardStock(Farmer who)
        {
            ...
            i = new Object(911, 1);
            reward_stock.Add(i, new int[4] { 0, 2147483647, 858, 50 });
            if (!Game1.MasterPlayer.hasOrWillReceiveMail("gotMissingStocklist"))
            {
                i = new Object(897, 1);
                (i as Object).questItem.Value = true;
                reward_stock.Add(i, new int[4] { 0, 1, 858, 50 });
            }
            i = new Object(Vector2.Zero, 275);
            reward_stock.Add(i, new int[4] { 0, 2147483647, 858, 10 });
            i = new Object(913, 4);
            reward_stock.Add(i, new int[4] { 0, 2147483647, 858, 20 });
            i = new Object(915, 4);
            reward_stock.Add(i, new int[4] { 0, 2147483647, 858, 20 });
            i = new Object(Vector2.Zero, 265);
            reward_stock.Add(i, new int[4] { 0, 2147483647, 858, 20 });
            if (!who.HasTownKey)
            {
                ...
                reward_stock.Add(key, new int[4] { 0, 1, 858, 20 });
            }
            i = new Object(896, 1);
            reward_stock.Add(i, new int[4] { 0, 2147483647, 858, 40 });
            i = new Object(891, 1);
            reward_stock.Add(i, new int[4] { 0, 2147483647, 858, 5 });
            i = new Object(908, 20);
            reward_stock.Add(i, new int[4] { 0, 2147483647, 858, 5 });
            i = new Object(917, 10);
            reward_stock.Add(i, new int[4] { 0, 2147483647, 858, 10 });
            i = new Hat(82);
            reward_stock.Add(i, new int[4] { 0, 2147483647, 858, 5 });
            i = new FishTankFurniture(2400, Vector2.Zero);
            reward_stock.Add(i, new int[4] { 0, 2147483647, 858, 20 });
            if (!who.craftingRecipes.ContainsKey("Heavy Tapper"))
            {
                i = new Object(Vector2.Zero, 264, isRecipe: true);
                reward_stock.Add(i, new int[4] { 0, 1, 858, 20 });
            }
            if (!who.craftingRecipes.ContainsKey("Hyper Speed-Gro"))
            {
                i = new Object(918, 1, isRecipe: true);
                reward_stock.Add(i, new int[4] { 0, 1, 858, 30 });
            }
            if (!who.craftingRecipes.ContainsKey("Deluxe Fertilizer"))
            {
                i = new Object(919, 1, isRecipe: true);
                reward_stock.Add(i, new int[4] { 0, 1, 858, 20 });
            }
            if (!who.craftingRecipes.ContainsKey("Hopper"))
            {
                i = new Object(Vector2.Zero, 275, isRecipe: true);
                reward_stock.Add(i, new int[4] { 0, 1, 858, 50 });
            }
            if (!who.craftingRecipes.ContainsKey("Magic Bait"))
            {
                i = new Object(908, 1, isRecipe: true);
                reward_stock.Add(i, new int[4] { 0, 1, 858, 20 });
            }
            ...
            {
                i = new Object(858, 2);
                reward_stock.Add(i, new int[4] { 0, 2147483647, 73, 1 });
            }
            i = new BedFurniture(2514, Vector2.Zero);
            reward_stock.Add(i, new int[4] { 0, 2147483647, 858, 50 });
            if (Game1.MasterPlayer.mailReceived.Contains("Farm_Eternal"))
            {
                i = new Object(928, 1);
                reward_stock.Add(i, new int[4] { 0, 2147483647, 858, 100 });
            }
            return reward_stock;
        }
        ...
        public static Dictionary<ISalable, int[]> getAdventureRecoveryStock()
        {
            ...
            foreach (Item i in Game1.player.itemsLostLastDeath)
            {
                if (i != null)
                {
                    ...
                    {
                        Utility.getSellToStorePriceOfItem(i),
                        i.Stack
                    });
                }
            }
        ...
        public static Dictionary<ISalable, int[]> getAdventureShopStock()
        {
            ...
            stock.Add(new MeleeWeapon(12), new int[2] { 250, infiniteStock });
            if (MineShaft.lowestLevelReached >= 15)
            {
                stock.Add(new MeleeWeapon(17), new int[2] { 500, infiniteStock });
            }
            if (MineShaft.lowestLevelReached >= 20)
            {
                stock.Add(new MeleeWeapon(1), new int[2] { 750, infiniteStock });
            }
            if (MineShaft.lowestLevelReached >= 25)
            {
                stock.Add(new MeleeWeapon(43), new int[2] { 850, infiniteStock });
                stock.Add(new MeleeWeapon(44), new int[2] { 1500, infiniteStock });
            }
            if (MineShaft.lowestLevelReached >= 40)
            {
                stock.Add(new MeleeWeapon(27), new int[2] { 2000, infiniteStock });
            }
            if (MineShaft.lowestLevelReached >= 45)
            {
                stock.Add(new MeleeWeapon(10), new int[2] { 2000, infiniteStock });
            }
            if (MineShaft.lowestLevelReached >= 55)
            {
                stock.Add(new MeleeWeapon(7), new int[2] { 4000, infiniteStock });
            }
            if (MineShaft.lowestLevelReached >= 75)
            {
                stock.Add(new MeleeWeapon(5), new int[2] { 6000, infiniteStock });
            }
            if (MineShaft.lowestLevelReached >= 90)
            {
                stock.Add(new MeleeWeapon(50), new int[2] { 9000, infiniteStock });
            }
            if (MineShaft.lowestLevelReached >= 120)
            {
                stock.Add(new MeleeWeapon(9), new int[2] { 25000, infiniteStock });
            }
            if (Game1.player.mailReceived.Contains("galaxySword"))
            {
                stock.Add(new MeleeWeapon(4), new int[2] { 50000, infiniteStock });
                stock.Add(new MeleeWeapon(23), new int[2] { 35000, infiniteStock });
                stock.Add(new MeleeWeapon(29), new int[2] { 75000, infiniteStock });
            }
            stock.Add(new Boots(504), new int[2] { 500, infiniteStock });
            if (MineShaft.lowestLevelReached >= 10)
            {
                stock.Add(new Boots(506), new int[2] { 500, infiniteStock });
            }
            if (MineShaft.lowestLevelReached >= 50)
            {
                stock.Add(new Boots(509), new int[2] { 750, infiniteStock });
            }
            if (MineShaft.lowestLevelReached >= 40)
            {
                stock.Add(new Boots(508), new int[2] { 1250, infiniteStock });
            }
            if (MineShaft.lowestLevelReached >= 80)
            {
                stock.Add(new Boots(512), new int[2] { 2000, infiniteStock });
                stock.Add(new Boots(511), new int[2] { 2500, infiniteStock });
            }
            if (MineShaft.lowestLevelReached >= 110)
            {
                stock.Add(new Boots(514), new int[2] { 5000, infiniteStock });
            }
            stock.Add(new Ring(529), new int[2] { 1000, infiniteStock });
            stock.Add(new Ring(530), new int[2] { 1000, infiniteStock });
            if (MineShaft.lowestLevelReached >= 40)
            {
                stock.Add(new Ring(531), new int[2] { 2500, infiniteStock });
                stock.Add(new Ring(532), new int[2] { 2500, infiniteStock });
            }
            if (MineShaft.lowestLevelReached >= 80)
            {
                stock.Add(new Ring(533), new int[2] { 5000, infiniteStock });
                stock.Add(new Ring(534), new int[2] { 5000, infiniteStock });
            }
            _ = MineShaft.lowestLevelReached;
            _ = 120;
            if (MineShaft.lowestLevelReached >= 40)
            {
                stock.Add(new Slingshot(32), new int[2] { 500, infiniteStock });
            }
            if (MineShaft.lowestLevelReached >= 70)
            {
                stock.Add(new Slingshot(33), new int[2] { 1000, infiniteStock });
            }
            if (Game1.player.craftingRecipes.ContainsKey("Explosive Ammo"))
            {
                stock.Add(new Object(441, int.MaxValue), new int[2] { 300, infiniteStock });
            }
            if (Game1.player.mailReceived.Contains("Gil_Slime Charmer Ring"))
            {
                stock.Add(new Ring(520), new int[2] { 25000, infiniteStock });
            }
            if (Game1.player.mailReceived.Contains("Gil_Savage Ring"))
            {
                stock.Add(new Ring(523), new int[2] { 25000, infiniteStock });
            }
            if (Game1.player.mailReceived.Contains("Gil_Burglar's Ring"))
            {
                stock.Add(new Ring(526), new int[2] { 20000, infiniteStock });
            }
            if (Game1.player.mailReceived.Contains("Gil_Vampire Ring"))
            {
                stock.Add(new Ring(522), new int[2] { 15000, infiniteStock });
            }
            if (Game1.player.mailReceived.Contains("Gil_Crabshell Ring"))
            {
                stock.Add(new Ring(810), new int[2] { 15000, infiniteStock });
            }
            if (Game1.player.mailReceived.Contains("Gil_Napalm Ring"))
            {
                stock.Add(new Ring(811), new int[2] { 30000, infiniteStock });
            }
            if (Game1.player.mailReceived.Contains("Gil_Skeleton Mask"))
            {
                stock.Add(new Hat(8), new int[2] { 20000, infiniteStock });
            }
            if (Game1.player.mailReceived.Contains("Gil_Hard Hat"))
            {
                stock.Add(new Hat(27), new int[2] { 20000, infiniteStock });
            }
            if (Game1.player.mailReceived.Contains("Gil_Arcane Hat"))
            {
                stock.Add(new Hat(60), new int[2] { 20000, infiniteStock });
            }
            if (Game1.player.mailReceived.Contains("Gil_Knight's Helmet"))
            {
                stock.Add(new Hat(50), new int[2] { 20000, infiniteStock });
            }
            if (Game1.player.mailReceived.Contains("Gil_Insect Head"))
            {
                stock.Add(new MeleeWeapon(13), new int[2] { 10000, infiniteStock });
            }
            return stock;
        }
        ...
        {
            Dictionary<ISalable, int[]> stock = new Dictionary<ISalable, int[]>();
            Utility.AddStock(stock, new Object(Vector2.Zero, 346, int.MaxValue));
            Utility.AddStock(stock, new Object(Vector2.Zero, 196, int.MaxValue));
            Utility.AddStock(stock, new Object(Vector2.Zero, 216, int.MaxValue));
            Utility.AddStock(stock, new Object(Vector2.Zero, 224, int.MaxValue));
            Utility.AddStock(stock, new Object(Vector2.Zero, 206, int.MaxValue));
            Utility.AddStock(stock, new Object(Vector2.Zero, 395, int.MaxValue));
            if (!Game1.player.cookingRecipes.ContainsKey("Hashbrowns"))
            {
                Utility.AddStock(stock, new Object(210, 1, isRecipe: true), 25);
            }
            if (!Game1.player.cookingRecipes.ContainsKey("Omelet"))
            {
                Utility.AddStock(stock, new Object(195, 1, isRecipe: true), 50);
            }
            if (!Game1.player.cookingRecipes.ContainsKey("Pancakes"))
            {
                Utility.AddStock(stock, new Object(211, 1, isRecipe: true), 50);
            }
            if (!Game1.player.cookingRecipes.ContainsKey("Bread"))
            {
                Utility.AddStock(stock, new Object(216, 1, isRecipe: true), 50);
            }
            if (!Game1.player.cookingRecipes.ContainsKey("Tortilla"))
            {
                Utility.AddStock(stock, new Object(229, 1, isRecipe: true), 50);
            }
            if (!Game1.player.cookingRecipes.ContainsKey("Pizza"))
            {
                Utility.AddStock(stock, new Object(206, 1, isRecipe: true), 75);
            }
            if (!Game1.player.cookingRecipes.ContainsKey("Maki Roll"))
            {
                Utility.AddStock(stock, new Object(228, 1, isRecipe: true), 150);
            }
            if (!Game1.player.cookingRecipes.ContainsKey("Cookies") && Game1.player.eventsSeen.Contains(19))
            {
                Utility.AddStock(stock, new Object(223, 1, isRecipe: true)
                {
                    name = "Cookies"
                }, 150);
            }
            ...
            {
                Utility.AddStock(stock, new Object(253, 1, isRecipe: true), 2500);
            }
            if ((int)Game1.dishOfTheDay.stack > 0 && !Utility.getForbiddenDishesOfTheDay().Contains(Game1.dishOfTheDay.ParentSheetIndex))
            {
                Utility.AddStock(stock, Game1.dishOfTheDay.getOne() as Object, Game1.dishOfTheDay.Price, Game1.dishOfTheDay.stack);
            }
            ...
            {
                Utility.AddStock(stock, new Object(Vector2.Zero, 732, int.MaxValue));
            }
            return stock;
        }
        ...
        {
            List<ModWallpaperOrFlooring> mod_data = Game1.content.Load<List<ModWallpaperOrFlooring>>("Data\\AdditionalWallpaperFlooring");
            Dictionary<ISalable, int[]> decors = new Dictionary<ISalable, int[]>();
            for (int l = 0; l < 112; l++)
            {
                decors.Add(new Wallpaper(l)
                {
                    Stack = int.MaxValue
                }, new int[2] { 0, 2147483647 });
            }
            foreach (ModWallpaperOrFlooring mod_data_entry2 in mod_data)
            {
                for (int k = 0; k < mod_data_entry2.Count; k++)
                {
                    if (!mod_data_entry2.IsFlooring)
                    {
                        Wallpaper wallpaper2 = new Wallpaper(mod_data_entry2.ID, k)
                        {
                            Stack = int.MaxValue
                        };
                        decors.Add(wallpaper2, new int[2] { 0, 2147483647 });
                    }
                }
            }
            for (int j = 0; j < 56; j++)
            {
                decors.Add(new Wallpaper(j, isFloor: true)
                {
                    Stack = int.MaxValue
                }, new int[2] { 0, 2147483647 });
            }
            foreach (ModWallpaperOrFlooring mod_data_entry in mod_data)
            {
                for (int i = 0; i < mod_data_entry.Count; i++)
                {
                    if (mod_data_entry.IsFlooring)
                    {
                        Wallpaper wallpaper = new Wallpaper(mod_data_entry.ID, i)
                        {
                            Stack = int.MaxValue
                        };
                        decors.Add(wallpaper, new int[2] { 0, 2147483647 });
                    }
                }
            }
            return decors;
        ...
        public static Dictionary<ISalable, int[]> getAllFurnituresForFree()
        {
            ...
            all_furnitures.Sort(new Comparison<Furniture>(SortAllFurnitures));
            foreach (Furniture f in all_furnitures)
            {
                decors.Add(f, new int[2] { 0, 2147483647 });
            }
            decors.Add(new Furniture(1402, Vector2.Zero), new int[2] { 0, 2147483647 });
            decors.Add(new TV(1680, Vector2.Zero), new int[2] { 0, 2147483647 });
            decors.Add(new TV(1466, Vector2.Zero), new int[2] { 0, 2147483647 });
            decors.Add(new TV(1468, Vector2.Zero), new int[2] { 0, 2147483647 });
            return decors;
        }
            ...
            else
            {
                ...
                if (Game1.player.isMarried() && Game1.player.team.GetSpouse(Game1.player.UniqueMultiplayerID).HasValue && Game1.player.GetSpouseFriendship().NextBirthingDate == null && r.NextDouble() < 0.05)
                {
                    ...
                    if (Game1.otherFarmers.ContainsKey(spouseID))
                    {
                        ...
                        if (spouse.currentLocation == Game1.player.currentLocation && (spouse.currentLocation == Game1.getLocationFromName(spouse.homeLocation) || spouse.currentLocation == Game1.getLocationFromName(Game1.player.homeLocation)) && Utility.playersCanGetPregnantHere(spouse.currentLocation as FarmHouse))
                        {
        ...
        {
            Dictionary<ISalable, int[]> stock = new Dictionary<ISalable, int[]>();
            stock.Add(new Object(178, 1), new int[2] { 50, 2147483647 });
            Object heater = new Object(Vector2.Zero, 104);
            heater.price.Value = 2000;
            heater.Stack = 1;
            stock.Add(heater, new int[2] { 2000, 2147483647 });
            if (Game1.player.hasItemWithNameThatContains("Milk Pail") == null)
            {
                stock.Add(new MilkPail(), new int[2] { 1000, 1 });
            }
            if (Game1.player.hasItemWithNameThatContains("Shears") == null)
            {
                stock.Add(new Shears(), new int[2] { 1000, 1 });
            }
            if ((int)Game1.player.farmingLevel >= 10)
            {
                stock.Add(new Object(Vector2.Zero, 165), new int[2] { 25000, 2147483647 });
            }
            stock.Add(new Object(Vector2.Zero, 45), new int[2] { 250, 2147483647 });
            if (Game1.MasterPlayer.mailReceived.Contains("Farm_Eternal"))
            {
                stock.Add(new Object(928, 1), new int[2] { 100000, 2147483647 });
            }
            return stock;
        }
        ...
        public static List<Object> getPurchaseAnimalStock()
        {
            ...
            Object o = new Object(100, 1, isRecipe: false, 400)
            {
                Name = "Chicken",
            ...
            list.Add(o);
            o = new Object(100, 1, isRecipe: false, 750)
            {
                Name = "Dairy Cow",
            ...
            list.Add(o);
            o = new Object(100, 1, isRecipe: false, 2000)
            {
                Name = "Goat",
            ...
            list.Add(o);
            o = new Object(100, 1, isRecipe: false, 600)
            {
                Name = "Duck",
            ...
            list.Add(o);
            o = new Object(100, 1, isRecipe: false, 4000)
            {
                Name = "Sheep",
            ...
            list.Add(o);
            o = new Object(100, 1, isRecipe: false, 8000)
            {
                Name = "Pig",
        ...
        public static void FixChildNameCollisions()
        {
            ...
            Utility.getAllCharacters(all_characters);
        ...
        public static Dictionary<ISalable, int[]> getBlacksmithUpgradeStock(Farmer who)
        {
            ...
            if (who.trashCanLevel < 4)
            {
                ...
                Tool trashCan = new GenericTool(toolNameString, Game1.content.LoadString("Strings\\StringsFromCSFiles:TrashCan_Description", ((who.trashCanLevel + 1) * 15).ToString() ?? ""), who.trashCanLevel + 1, 13 + who.trashCanLevel, 13 + who.trashCanLevel);
        ...
        public static Character isThereAFarmerOrCharacterWithinDistance(Vector2 tileLocation, int tilesAway, GameLocation environment)
        {
            ...
            return Utility.isThereAFarmerWithinDistance(tileLocation, tilesAway, environment);
        }
        ...
        public static bool canGrabSomethingFromHere(int x, int y, Farmer who)
        {
            ...
            if (who.IsLocalPlayer)
            {
                ...
                if (Game1.currentLocation != null)
                {
                    ...
                    {
                        if (f.getBoundingBox(f.TileLocation).Contains(Utility.Vector2ToPoint(tileLocation * 64f)) && f.Name.Contains("Table") && f.heldObject.Value != null)
                        {
                            return true;
                        }
                    }
        ...
        public static bool isPlacementForbiddenHere(GameLocation location)
        {
            ...
            return Utility.isPlacementForbiddenHere(location.name);
        }
        ...
        {
            if (!Utility.withinRadiusOfPlayer(x, y, 1, f))
            {
                return Utility._HasNonMousePlacementLeeway(x, y, item, f);
            }
            return true;
        }
        ...
        public static bool playerCanPlaceItemHere(GameLocation location, Item item, int x, int y, Farmer f)
        {
            ...
            if (Utility.isWithinTileWithLeeway(x, y, item, f) || (item is Wallpaper && location is DecoratableLocation) || (item is Furniture && location.CanPlaceThisFurnitureHere(item as Furniture)))
            {
                ...
                if (item.canBePlacedHere(location, tileLocation))
                {
                    ...
                    if (Utility.itemCanBePlaced(location, tileLocation, item) || Utility.isViableSeedSpot(location, tileLocation, item))
                    {
                        return true;
                    }
                }
            ...
            if (i is Object)
            {
                ...
                if (o is StorageFurniture)
                {
                    foreach (Item item2 in (o as StorageFurniture).heldItems)
                    {
                        if (item2 != null)
                        {
                            Utility._recursiveIterateItem(item2, action);
                        }
                    }
                }
                if (o is Chest)
                {
                    foreach (Item item in (o as Chest).items)
                    {
                        if (item != null)
                        {
                            Utility._recursiveIterateItem(item, action);
                        }
                    }
                }
                if (o.heldObject.Value != null)
                {
                    Utility._recursiveIterateItem((Object)o.heldObject, action);
                }
            }
            action(i);
        }
        ...
        protected static void _recursiveIterateLocation(GameLocation l, Action<Item> action)
        {
            ...
            if (l != null)
            {
                ...
                {
                    Utility._recursiveIterateItem(item5, action);
                }
            }
            if (l is IslandFarmHouse)
            {
                foreach (Item item4 in (l as IslandFarmHouse).fridge.Value.items)
                {
                    if (item4 != null)
                    {
                        Utility._recursiveIterateItem(item4, action);
                    }
                }
            }
            if (l is FarmHouse)
            {
                foreach (Item item3 in (l as FarmHouse).fridge.Value.items)
                {
                    if (item3 != null)
                    {
                        Utility._recursiveIterateItem(item3, action);
                    }
                }
            }
            foreach (NPC character in l.characters)
            {
                ...
                {
                    Utility._recursiveIterateItem((character as Child).hat.Value, action);
                }
                if (character is Horse && (character as Horse).hat.Value != null)
                {
                    Utility._recursiveIterateItem((character as Horse).hat.Value, action);
                }
            }
            if (l is BuildableGameLocation)
            {
                foreach (Building b in (l as BuildableGameLocation).buildings)
                {
                    if (b.indoors.Value != null)
                    {
                        Utility._recursiveIterateLocation(b.indoors.Value, action);
                    }
                    if (b is Mill)
                    {
            ...
            {
                Utility._recursiveIterateItem(value, action);
            }
            foreach (Debris d in l.debris)
            {
                if (d.item != null)
                {
                    Utility._recursiveIterateItem(d.item, action);
                }
            }
        }
        ...
        public static void iterateAllItems(Action<Item> action)
        {
            ...
            foreach (Farmer farmer in Game1.getAllFarmers())
            {
                ...
                Utility._recursiveIterateItem(farmer.shirtItem.Value, action);
                Utility._recursiveIterateItem(farmer.pantsItem.Value, action);
                Utility._recursiveIterateItem(farmer.boots.Value, action);
                Utility._recursiveIterateItem(farmer.hat.Value, action);
                Utility._recursiveIterateItem(farmer.leftRing.Value, action);
                Utility._recursiveIterateItem(farmer.rightRing.Value, action);
                ...
                {
                    Utility._recursiveIterateItem(farmer.recoveredItem, action);
                }
            }
        ...
        protected static void _recursiveIterateLocationCrops(GameLocation l, Action<Crop> action)
        {
            ...
            if (l is BuildableGameLocation)
            {
                foreach (Building b in (l as BuildableGameLocation).buildings)
                {
                    if (b.indoors.Value != null)
                    {
                        Utility._recursiveIterateLocationCrops(b.indoors.Value, action);
                    }
                }
            }
        ...
        {
            return Utility.getRandomTownNPC(Game1.random);
        }
        ...
        public static NPC getTownNPCByGiftTasteIndex(int index)
        {
            ...
            while (i == null)
            {
                i = Game1.getCharacterFromName(giftTastes.ElementAt(add).Key);
                add++;
                add %= 30;
            }
            return i;
        ...
        public static int getGrandpaScore()
        {
            ...
            int numberOfFriendsWithinThisRange = Utility.getNumberOfFriendsWithinThisRange(Game1.player, 1975, 999999);
            ...
            try
            {
                if (Game1.objectInformation.ContainsKey(index))
                {
                    ...
                    if (misc_info.Length > 6)
                    {
                        ...
                        if (treasures == null || treasures.Length == 0 || !int.TryParse(treasures[0], out var _))
                        {
                            return false;
                        }
                        return true;
        ...
        {
            bool is_geode = Utility.IsGeode(geode);
            if (is_geode)
            {
                try
                {
        ...
        public static Vector2 GetNearbyValidPlacementPosition(Farmer who, GameLocation location, Item item, int x, int y)
        {
            ...
            for (int offset = 0; offset < scan_distance; offset++)
            {
                ...
                if ((!who.GetBoundingBox().Intersects(bounding_box) && !is_passable) || Utility.playerCanPlaceItemHere(location, item, checked_x, checked_y, who))
                {
        ...
        {
            return Utility.getVelocityTowardPoint(startingPoint, new Vector2(f.GetBoundingBox().X, f.GetBoundingBox().Y), speed);
        }
        ...
        {
            return Utility.getVelocityTowardPoint(new Vector2(startingPoint.X, startingPoint.Y), endingPoint, speed);
        }
        ...
        {
            return Utility.generateNewFarm(skipFarmGeneration, loadForNewGame: true);
        }
        ...
        public static void recolorDialogueAndMenu(string theme)
        {
            ...
            case "Basic":
                ...
                color2 = new Color(color1.R + 60, color1.G + 60, color1.B + 60);
                color3 = new Color(color2.R + 30, color2.G + 30, color2.B + 30);
                color4 = new Color(color3.R + 30, color3.G + 30, color3.B + 30);
                color5 = new Color(color4.R + 15, color4.G + 15, color4.B + 15);
                color6 = new Color(color5.R + 15, color5.G + 15, color5.B + 15);
                color7 = new Color(220, 215, 194);
                color8 = new Color(Math.Min(255, color7.R + 30), Math.Min(255, color7.G + 30), Math.Min(255, color7.B + 30));
                color9 = new Color(color7.R - 30, color7.G - 30, color7.B - 30);
                break;
            case "Outer Space":
            ...
            case "Bombs Away":
                ...
                color4 = new Color(color3.R + 30, color3.G + 30, color3.B + 30);
                color5 = Color.Tan;
                color6 = new Color(color4.R + 30, color4.G + 30, color4.B + 30);
            ...
            case "Polynomial":
                ...
                color5 = new Color(color4.R + 30, color4.G + 30, color4.B + 30);
            ...
            case "Duchess":
                ...
                color2 = new Color(color1.R + 60, color1.G + 60, color1.B + 30);
                color3 = new Color(color2.R + 30, color2.G + 30, color2.B + 20);
                color4 = new Color(color3.R + 30, color3.G + 30, color3.B + 20);
                color5 = new Color(color4.R + 15, color4.G + 15, color4.B + 10);
                color6 = new Color(color5.R + 15, color5.G + 15, color5.B + 10);
                color7 = new Color(227, 221, 174);
                color8 = new Color(Math.Min(255, color7.R + 30), Math.Min(255, color7.G + 30), Math.Min(255, color7.B + 30));
                color9 = new Color(color7.R - 30, color7.G - 30, color7.B - 30);
                break;
            }
            Game1.menuTexture = ColorChanger.swapColor(Game1.menuTexture, 15633, color1.R, color1.G, color1.B);
            Game1.menuTexture = ColorChanger.swapColor(Game1.menuTexture, 15645, color6.R, color6.G, color6.B);
            Game1.menuTexture = ColorChanger.swapColor(Game1.menuTexture, 15649, color4.R, color4.G, color4.B);
            Game1.menuTexture = ColorChanger.swapColor(Game1.menuTexture, 15641, color4.R, color4.G, color4.B);
            Game1.menuTexture = ColorChanger.swapColor(Game1.menuTexture, 15637, color3.R, color3.G, color3.B);
            Game1.menuTexture = ColorChanger.swapColor(Game1.menuTexture, 15666, color7.R, color7.G, color7.B);
            Game1.menuTexture = ColorChanger.swapColor(Game1.menuTexture, 40577, color8.R, color8.G, color8.B);
            Game1.menuTexture = ColorChanger.swapColor(Game1.menuTexture, 40637, color9.R, color9.G, color9.B);
            Game1.toolIconBox = ColorChanger.swapColor(Game1.toolIconBox, 1760, color1.R, color1.G, color1.B);
            Game1.toolIconBox = ColorChanger.swapColor(Game1.toolIconBox, 1764, color3.R, color3.G, color3.B);
            Game1.toolIconBox = ColorChanger.swapColor(Game1.toolIconBox, 1768, color4.R, color4.G, color4.B);
            Game1.toolIconBox = ColorChanger.swapColor(Game1.toolIconBox, 1841, color6.R, color6.G, color6.B);
            Game1.toolIconBox = ColorChanger.swapColor(Game1.toolIconBox, 1792, color7.R, color7.G, color7.B);
            Game1.toolIconBox = ColorChanger.swapColor(Game1.toolIconBox, 1834, color8.R, color8.G, color8.B);
            Game1.toolIconBox = ColorChanger.swapColor(Game1.toolIconBox, 1773, color9.R, color9.G, color9.B);
        }
        ...
        public static void HSLtoRGB(double h, double s, double l, out int r, out int g, out int b)
        {
            ...
            {
                double_r = Utility.QQHtoRGB(p1, p2, h + 120.0);
                double_g = Utility.QQHtoRGB(p1, p2, h);
                double_b = Utility.QQHtoRGB(p1, p2, h - 120.0);
            }

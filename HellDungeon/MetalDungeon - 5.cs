...
{
    public class MetalDungeonLevelGenerator : BaseDungeonLevelGenerator
    {
        ...
        public MetalDungeonLevelGenerator() : base()
        {
        ...
        /*
        [XmlIgnore]
        public readonly NetPointDictionary<string, NetString> mermaiddoors = new NetPointDictionary<string, NetString>();

        [XmlIgnore]
        public readonly MermaidDoorDictionary mermaidDoors;

        public MetalDungeonLevelGenerator() : base()
        {
            mermaidDoors = new MermaidDoorDictionary(this);
            NetFields.AddFields(mermaiddoors, mermaidDoors);
        }
        ...
        public override void MakeMapModifications(bool force = false)
        {
            ...
            mermaidDoors.MakeMapModifications();

        }

        private bool mermaiddoorHasStateOpen(Point mermaiddoor)
        {
            bool isOpen;
            return mermaidDoors.TryGetValue(mermaiddoor, out isOpen) && isOpen;
        } */
        ...
        public override void Generate(HellDungeon location, ref Vector2 warpFromPrev, ref Vector2 warpFromNext)
        {
            ...
            var caveMap = Game1.game1.xTileContent.Load<Map>(Mod.instance.Helper.ModContent.GetInternalAssetName("assets/maps/HellDungeonMetal.tmx").BaseName);
...

            {
               ...
               // PlaceMonster(location, 12, x + 53, y + 79);
                //PlaceMonster(location, 12, x + 55, y + 79);

               // PlaceMonster(location, 12, x + 53, y + 84);
               // PlaceMonster(location, 12, x + 55, y + 84);
               // PlaceMonster(location, 12, x + 51, y + 84);

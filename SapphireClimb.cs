...
{
    public class ClimbLevelGenerator :SapphireBaseLevelGenerator
    {
        ...
        public override void Generate(SapphireVolcano location, ref Vector2 warpFromPrev, ref Vector2 warpFromNext)
        {
...

            {
                ...
                chest.addItem(new Object(441, 25));
            ...
            }
            {
                ...
                chest.type.Value = "interactive";
                chest.SetBigCraftableSpriteIndex(227);
                chest.addItem(new Object(288, 5));
                if (location.netObjects.ContainsKey(position))
                    location.netObjects.Remove(position);
                location.netObjects.Add(position, chest);
            }
            ...
            }
            {
                ...
                chest.type.Value = "interactive";
                chest.SetBigCraftableSpriteIndex(227);
                chest.addItem(new Object(863, 1));
                if (location.netObjects.ContainsKey(position))
                    location.netObjects.Remove(position);
                location.netObjects.Add(position, chest);
            }
            {
                ...
                chest.type.Value = "interactive";
                chest.SetBigCraftableSpriteIndex(227);
                chest.addItem(new Object(604, 5));
                if (location.netObjects.ContainsKey(position))
                    location.netObjects.Remove(position);
                location.netObjects.Add(position, chest);
            }
            {
                ...
                chest.type.Value = "interactive";
                chest.SetBigCraftableSpriteIndex(227);
                chest.addItem(new Object(253, 10));
                if (location.netObjects.ContainsKey(position))
                    location.netObjects.Remove(position);
                location.netObjects.Add(position, chest);
            }

            {
                ...
                Object o = new Object(166, 1); //Treasure Chest
            ...
            }
            {
                ...
                Object o = new Object(336, 1); //Gold Bar
                o.IsSpawnedObject = true;
                o.CanBeGrabbed = true;
                location.Objects.Add(objectPos, o);
            }
            {
                ...
                Object o = new Object(348, 1);  //Wine
                o.IsSpawnedObject = true;
                o.CanBeGrabbed = true;
                location.Objects.Add(objectPos, o);
            }

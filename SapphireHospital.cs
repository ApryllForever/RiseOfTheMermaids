...
{
    [XmlType("Mods_ApryllForever_RestStopLocations_SapphireHospital")]
    public class SapphireHospital : SapphireLocation
    {
        ...
        public SapphireHospital() { }
        public SapphireHospital(IModContentHelper content)
        : base(content, "SapphireHospital", "SapphireHospital")
        {
        }
